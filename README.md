...
```xml
<context:component-scan base-package="com.xlwansdk.*" use-default-filters="false">
...
<filter>
   ...
   <filter-class>com.xlwansdk.common.filter.CorsFilter</filter-class>
   <init-param>
 ...
 * @author leeyom
 * @date 2017年10月19日 10:41
 * @see com.xlwansdk.authorization.manager.TokenManager
 */
@Component
